 ...
 *
 * Usage:
 *   import { RdsCard, RdsCardHeader, RdsCardContent } from "@meinc/rds-ui-core";
 *
...
const RdsCardVariants = cva("rounded-lg border bg-card text-card-foreground", {
  variants: {
    variant: {
      ...
      player:
        "shadow-md bg-gradient-to-b from-card to-card/95 border-border/50",
      media: "shadow-sm overflow-hidden",
      stat: "shadow-sm",
      track:
        "shadow-sm hover:bg-accent/50 transition-colors cursor-pointer border-transparent hover:border-border",
      release:
        "shadow-md overflow-hidden hover:shadow-lg transition-shadow",
      comment:
        "shadow-none border-0 bg-muted/30 rounded-md",
      panel: "shadow-none border rounded-lg bg-muted/20",
    },
    padding: {
      default: "",
      none: "",
